...
// Query untuk mengambil data kamar secara lengkap
            ...
            <table class="kamar-table">
                ...
                <tbody>
                    <?php if (mysqli_num_rows($result_kamar) > 0) : ?>
                        ...
                        <tr>
                            <!-- Menggunakan id_kamar dari tabel kamar -->
                            <td><strong><?php echo $row['id_kamar']; ?></strong></td>
                            ...
                            <td>
                                <!-- Status kamar menggunakan enum 'terisi'/'kosong' -->
                            ...
                            <td class="action-icons">
                                ...
                                <a href="hapus_kamar.php?id=<?php echo $row['id_kamar']; ?>" class="delete" onclick="return confirm('Yakin ingin menghapus kamar ini?')"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    <?php else : ?>
