...
// 1. ATUR DEFAULT TANGGAL (Jika filter belum diisi, default ke rentang tanggal di contoh gambar)
$tgl_awal_pilihan  = $_GET['tgl_awal'] ?? '2026-02-01';
$tgl_akhir_pilihan = $_GET['tgl_akhir'] ?? '2026-03-11';

$target_bulanan = 5000000;

// 2. UBAH LOGIKA WHERE MENGGUNAKAN BETWEEN BERDASARKAN INPUT KUSTOM
...
// Query utama untuk ringkasan bulanan (Tetap di-group berdasarkan bulan dari rentang yang dipilih)
$sql = "SELECT 
            bulan_num,
            bulan_nama,
...
// Query riwayat hunian berdasarkan rentang tanggal kustom
$sql_riwayat = "SELECT 
                    k.nomor_kamar,
                    tk.nama_tipe,
                    c.nama, 
...
// Statistik Box Atas (Dibiarkan berbasis bulan berjalan saat ini seperti kode awal Anda)
$bulan_ini = date('m');
$tahun_ini = date('Y');
...
<head>
    ...
    <link class="styles" rel="stylesheet" href="../assets/css/dashboard_admin.css">
    <link class="styles" rel="stylesheet" href="../assets/css/laporan_admin.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <style>
        /* Gaya tambahan untuk menyelaraskan form input tanggal */
        .date-filter-form {
            display: flex;
            align-items: center;
            gap: 10px;
...
<body>
        ...
        <div class="main-content">
            <header class="header-top">
                ...
                <div class="header-actions">
                    <form method="GET" action="" class="date-filter-form" id="form-filter">
                        <div class="date-input-group">
                            <input type="date" name="tgl_awal" id="tgl_awal" value="<?= $tgl_awal_pilihan; ?>" onchange="submitFilter()">
                        </div>
                        <span class="span-separator">s.d</span>
                        <div class="date-input-group">
                            <input type="date" name="tgl_akhir" id="tgl_akhir" value="<?= $tgl_akhir_pilihan; ?>" onchange="submitFilter()">
                        </div>
                    </form>
                    
                    <a href="export_pdf.php?tgl_awal=<?= $tgl_awal_pilihan; ?>&tgl_akhir=<?= $tgl_akhir_pilihan; ?>" class="btn-export" target="_blank">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" style="text-align: center; color: #888; padding: 20px;">
                                    Belum ada data transaksi pada rentang tanggal terpilih.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
    ...
    <script>
        ...
        // Fungsi otomatis submit ketika user selesai memilih salah satu tanggal
